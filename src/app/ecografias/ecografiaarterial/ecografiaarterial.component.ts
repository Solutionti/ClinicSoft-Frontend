...
@Component({
  ...
  templateUrl: './ecografiaarterial.component.html',
  styleUrl: './ecografiaarterial.component.css',
  providers: [ConfirmationService,MessageService]
})
export class EcografiaarterialComponent implements OnInit {
  ...
  ecografiaarterialForm = new FormGroup({
  ...
  buscarPacientes() {
    this.spinner = false;
    let documento = this.ecografiaarterialForm.get("dni_ecografia_mama")?.value;
    ...
    this.admisionServices
        ...
        .subscribe((response: any ) => {
          if(response.status == 200) {
            ...
            this.ecografiaarterialForm.patchValue({

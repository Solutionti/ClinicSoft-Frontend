  ...
  getPacientesId(documento: any ) {
    this.admisionService
        ...
        .subscribe((response: any ) => {
          ...
          this.crearPacienteForm.patchValue(
            {
               crearpaciente_dni: response.documento,
               crearpaciente_apellido: response.apellido,
               crearpaciente_nombre: response.nombre,
               crearpaciente_hc: response.hc,
               crearpaciente_celular: response.telefono,
               crearpaciente_sexo: response.sexo,
               crearpaciente_fechanacimiento: response.fecha_nacimiento,
               crearpaciente_edad: response.edad,
               crearpaciente_direccion: response.direccion,
               crearpaciente_departamento: response.departamento,
               crearpaciente_provincia: response.provincia,
               crearpaciente_distrito: response.distrito,
               crearpaciente_ocupacion: response.ocupacion,
               crearpaciente_grado: response.grado_academico,
               crearpaciente_estadocivil: response.estado_civil,
               crearpaciente_esmenor: response.menor_edad,
               crearpaciente_documentores: response.documento,
               crearpaciente_telefonores: response.telefono,
            }
           );
        });
  }
